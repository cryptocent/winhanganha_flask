...
('AC007', 'A007', 'U001', 'Confirm wording with language group before release', '2026-05-20'),
('AC008', 'A008', 'U001', 'Access request process should be used for this item', '2026-05-21'),
('AC009', 'A009', 'U004', 'Approved description can be shown on public page', '2026-05-22'),
('AC010', 'A010', 'U001', 'A shorter description may be suitable if the family names and sensitive place details are removed.', '2026-05-21'),
('AC011', 'A011', 'U004', 'Recommend restricted access until further consultation with the relevant family group has been completed.', '2026-05-22'),
('AC012', 'A012', 'U004', 'Metadata can be updated once the review group confirms the approved access level and public catalogue wording.', '2026-05-23'),
('AC013', 'A013', 'U001', 'Confirm wording with language group before release', '2026-05-20'),
('AC014', 'A014', 'U001', 'Access request process should be used for this item', '2026-05-21'),
('AC015', 'A015', 'U004', 'Approved description can be shown on public page', '2026-05-22');
-- --------------------------------------------------------
...
('A007', 'I007', 'U004', '2026-05-22', 'Restricted access', 'Detailed place data requires approval before access.'),
('A008', 'I008', 'U001', '2026-05-20', 'Continue review', 'Language spelling and access notes require confirmation'),
('A009', 'I009', 'U001', '2026-05-21', 'Restricted access', 'Recording contains family knowledge and should not be public'),
('A010', 'I010', 'U004', '2026-05-22', 'Public release approved', 'Description and access conditions approved'),
('A011', 'I011', 'U001', '2026-05-21', 'Continue review', 'Confirm whether item can be released with restricted access or must remain private.'),
('A012', 'I012', 'U004', '2026-05-22', 'Keep private', 'Internal consultation material should remain private.'),
('A013', 'I013', 'U004', '2026-05-22', 'Restricted access', 'Detailed place data requires approval before access.'),
('A014', 'I014', 'U001', '2026-05-20', 'Continue review', 'Language spelling and access notes require confirmation'),
('A015', 'I015', 'U001', '2026-05-21', 'Restricted access', 'Recording contains family knowledge and should not be public');
...
('M003', 'I003', 'Individual owned', 'Private', NULL, 'High', '', '', 'Not approved for public release'),
...
('M005', 'I005', '', 'Public', NULL, 'Low', '', '', 'Approved'),
('M006', 'I006', 'Community owned', 'Public', NULL, 'Low', 'What if you find an Aboriginal grinding stone?\r\nDo not disturb it or remove it from the site. Check whether the stone has the typical characteristics of an Aboriginal grinding stone. If it does, record its location and write a brief description of its condition. Note whether it is under threat of disturbance.\r\nPlease help to preserve Aboriginal cultural places by reporting their presence to First Peoples – State Relations.\r\n', '', 'Approved'),
('M007', 'I007', '', 'Restricted', NULL, 'High', '', '', 'Not approved for public release'),
('M008', 'I008', 'Individual owned', 'Public', NULL, 'Medium', '', '', 'Approved'),
('M009', 'I009', '', 'Public', NULL, 'Low', '', '', 'Approved'),
('M010', 'I010', '', 'Restricted', NULL, 'High', '', '', 'Not approved for public release'),
('M011', 'I011', 'Organisation owned', 'Restricted', NULL, 'Medium', '', '', 'Approved with restriction'),
('M012', 'I012', NULL, 'Under Assessment', NULL, 'Not yet assessed', NULL, NULL, 'Awaiting Elder review'),
('M013', 'I013', 'Unknown', 'Public', NULL, 'Not yet assessed', '', '', 'Approved'),
('M014', 'I014', 'Community owned', 'Restricted', NULL, 'Medium', '', '', 'Approved with restrictions'),
('M015', 'I015', '', 'Public', NULL, 'Low', '', '', 'Approved');
